            ...
            <div key={course.id} className="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition">
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  <Link to={`/courses/${course.id}`} className="w-full text-center bg-blue-600 text-white px-3 py-2 rounded hover:bg-blue-700 transition text-sm">View Details</Link>
                </div>
              </div>
            </div>
          ))}
